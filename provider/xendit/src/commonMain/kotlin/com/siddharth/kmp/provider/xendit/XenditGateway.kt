 ...
 * kicks off the mock delayed-flip (`POST /mock/xendit/{orderId}/settle`) and returns `Pending`
...
class XenditGateway(
    ...
    override suspend fun pay(
        ...
        runCatching {
            httpClient.post("$baseUrl/mock/xendit/${prepared.orderId}/settle?delayMs=$MOCK_FLIP_DELAY_MS")
        }.onFailure { AppLog.w("Could not schedule mock xendit flip for ${prepared.orderId}", it, tag = TAG) }
