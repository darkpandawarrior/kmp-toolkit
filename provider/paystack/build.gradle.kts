...
android {
    namespace = "com.siddharth.kmp.provider.paystack"
    compileSdk = 37
    ...
    // Publish only the release variant as com.siddharth.kmp:paystack.
    publishing {
...
dependencies {
    ...
    // Compose this module needs — PaystackGateway touches only the non-@Composable relay types, it
...
// Declare the release publication; artifactId ("paystack") + the GitHub Packages repo come from the
