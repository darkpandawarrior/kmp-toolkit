...
class SubmitHandlerTest {
    ...
    @Test
    fun success_emits_submitting_then_success() =
        runTest {
    ...
    @Test
    fun retryable_failure_enqueues_offline_and_flags_queued() =
        runTest {
    ...
    @Test
    fun non_retryable_failure_does_not_enqueue() =
        runTest {
            var enqueued = false
            submitFlow(
                payload = "job-2",
    ...
    @Test
    fun retryable_failure_without_enqueue_callback_is_plain_failure() =
        runTest {
